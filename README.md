...
A World of Warcraft Classic TBC add-on that improves chat readability by custom color-coding your outbound messages in whisper, party, and bnet channels.
...
- **Draggable UI**: Move the settings frame and minimap button to your preferred positions
- **Persistent Settings**: Your color choices and UI positions are saved across sessions
...
WoWhisper now includes an easy-to-use in-game color picker:

1. **Click the WoWhisper minimap button** (scroll icon near the 10 o'clock position)
...
- The settings frame is **draggable** - position it anywhere you like
- The minimap button is **draggable** - hold and drag it around the minimap edge
- Press **ESC** to quickly close the settings window
- All your color choices and UI positions are automatically saved
